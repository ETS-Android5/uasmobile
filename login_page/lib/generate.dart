...
class GeneratePageState extends State<GeneratePage> {
  ...
  Widget build(BuildContext context) {
    final qrdataFeed = firebaseUser
        .email; //The qr data is assigned with the user's unique firebase userid so that it would be unique for each user

    return Scaffold(
      resizeToAvoidBottomInset:
          false, //added this line to avoid bottom overflow error
      appBar: AppBar(
