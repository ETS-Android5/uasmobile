  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Scanner", style: TextStyle(fontFamily: 'montserrat1')),
        centerTitle: true,
      ),
      body: Container(
              ...
              onPressed: () async {
                ...
                setState(() {
                  ...
                  firestoreInstance
                      ...
                      .set({"User info": qrCodeResult}).then((_) {
                    print(firebaseUser.uid);
                  });

                  qrCodeResult =
                      codeScanner; // default user data stored as scan result in case scan is not possible
                });
              },
              child: Text(
                "Open Scanner",
